...
var extend=extend||{}
var __this__=extend
extend.__VERSION__='2.2.3';extend.Counters={'Instances':0}
...
{return null}}
extend.type=function(value){var __this__=extend;return typeof(value)}
extend.access=function(value,index){var __this__=extend;if(extend.isList(value))
{if((index>=0))
{return value[index]}
else if(true)
...
extend.isList=function(value){var __this__=extend;return Object.prototype.toString.call(value)==='[object Array]';}
extend.isNumber=function(value){var __this__=extend;return(typeof(value)=='number')}
...
extend.isObject=function(value){var __this__=extend;return!!(typeof value=="object")}
...
extend.map=function(callback,iterable){var __this__=extend;var result=[];extend.iterate(iterable,function(e){result.append(callback(e))},__this__)
return result}
extend.filter=function(callback,iterable){var __this__=extend;var result=[];extend.iterate(iterable,function(e){if(callback(e))
{result.append(e)}},__this__)
return result}
extend.reduce=function(callback,iterable){var __this__=extend;var first=true;var result=undefined;extend.iterate(iterable,function(e){if(first)
{result=callback(e);first=false;}
else if(true)
{result=callback(e,result);}},__this__)
return result}
extend.init=function(){var __this__=extend;String.__len__=function(){return this.length};Array.extend=function(array){extend.iterate(array,function(e){this.append(e)},__this__)};Array.append=function(e){this.push(e)};Array.insert=function(e,i){this.splice(i,e)};Array.slice=function(){};Array.__iter__=function(){return this.length};Array.__len__=function(){return this.length};Object.keys=function(){var result=[];for(var k in this){var key=k;result.push(key)}
return result};Object.items=function(){var result=[];for(var k in this){var key=k;result.push([key,this[key]])}
return result};Object.values=function(){var result=[];for(var k in this){var key=k;result.push([key,this[key]])}
return result};Object.hasKey=function(key){return(typeof(this[key])!='undefined')};Object.get=function(key){return this[key]};Object.set=function(key,value){this[key]=value;return this};Object.setDefault=function(key,value){if((typeof(this[key])!='undefined'))
{return this[key]}
else if(true)
{this[key]=value;return value}};Object.__iter__=function(){};Object.__len__=function(){return this.keys().length};}
extend.init()